...
if os.path.exists(r"C:\Users\denil\Desktop\projetos\controle-442619-1a5ef1da59f3.json"):
    ...
    # 2. Está no Streamlit Cloud: lê a string do secrets
    try:
        # O segredo está na chave 'credentials_json' (configurada no secrets)
        creds_str = st.secrets["credentials_json"]
        creds_dict = json.loads(creds_str)
        # Salva em um arquivo temporário para o código funcionar
