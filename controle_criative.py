...
# Carrega credenciais diretamente do secrets (formato TOML)
...
# ... (restante do código permanece igual, usando conectar_google() e as funções de Docs)
...
def buscar_conteudo_documento(doc_url):
    try:
        ...
        # Não exibe erro para não travar o app, apenas retorna string vazia
        return ""
