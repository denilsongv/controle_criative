...
NOME_ABA = "criative"
ID_PASTA_COMPARTILHADA = "1IdIqXjIc4oWd6Ohpg4Oef3lIPGPjUMvJ"

def obter_credenciais():
    # Lê do secrets (string JSON)
...
def criar_documento_google_docs(titulo, texto):
    ...
    try:
        ...
        file_metadata = {
            ...
            'parents': [ID_PASTA_COMPARTILHADA]
        }
...
# ==================== INTERFACE (resumida, mas completa) ====================
st.set_page_config(page_title="Criative - Gestão", layout="wide")
st.title("📱 Criative - Gestão de Lançamentos (Google Docs + Pasta Compartilhada)")
